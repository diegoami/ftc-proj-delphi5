...
uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs, stringfns, comctrls;
...
type
  ...
  public
    ...
    procedure CopyFromTo(Orig,Dest : String);
...
procedure TDADirScan.CopyFromTo(Orig,Dest : String);
begin
  isCopying := True;
...
{file must have one of the accepted extensions }
  ...
  for i := 0 to FAcceptedFiles.Count-1 do begin
    ...
    PP := Length(FileName)-PosLast('.',FileName);
